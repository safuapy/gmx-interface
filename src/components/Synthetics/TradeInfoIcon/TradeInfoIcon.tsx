      ...
      <ul className={UL_CLASS_NAME}>
        ...
        {isTradeBox ? (
          <li className={LI_CLASS_NAME}>
            ...
            <ExternalLink href="https://docs.intelmarkets.trade/docs/trading/v2/#limit-orders">
        ...
        <li className={LI_CLASS_NAME}>
          ...
          <ExternalLink href="https://docs.intelmarkets.trade/docs/trading/v2/#take-profit-and-stop-loss-orders">
            <Trans>Read more</Trans>
          </ExternalLink>
          .
        </li>
        {isTradeBox ? (
          <li className={LI_CLASS_NAME}>
            ...
            <ExternalLink href="https://docs.intelmarkets.trade/docs/trading/v2/#stop-market-orders">
              <Trans>Read more</Trans>
            </ExternalLink>
            .
          </li>
        ...
        <li className={LI_CLASS_NAME}>
          ...
          <ExternalLink href="https://docs.intelmarkets.trade/docs/trading/v2/#twap-orders">
            <Trans>Read more</Trans>
          </ExternalLink>
          .
        </li>
