        ...
        <div>
          ...
          <div className="Home-token-card-option-info">
            ...
            <div className="Home-token-card-option-apr">
              <Trans>Protocol APR:</Trans> <APRLabel chainId={ETHEREUM} label="avgAprTotal" />
            </div>
          </div>
        </div>
      ...
      <div className="Home-token-card-option">
        <div>
          ...
          <div className="Home-token-card-option-info">
            <div className="Home-token-card-option-title">
              <Trans>
                Liquidity Provider tokens for IntelMarkets V2 vaults. Earn fees from market operations and trading activity.
              </Trans>
            </div>
          </div>
          ...
          <div className="Home-token-card-option-apr">
            <Trans>Current Max. APY:</Trans> {maxGlvApyText?.[ETHEREUM]}
          </div>
        </div>
        ...
        <div className="mt-50 flex flex-col gap-15 text-slate-100">
          ...
          <div className={cx("flex justify-between", { "flex-col gap-15": isMobile })}>
            <div className={cx("buy flex gap-15", { "flex-col": isMobile })}>
              <BuyLink
                to={getTrackingLink("/pools?tab=liquidity")}
                network={ETHEREUM}
                chainId={chainId}
                active={active}
                showRedirectModal={showRedirectModal}
      ...
      <div className="Home-token-card-option">
        <div>
          ...
          <div className="Home-token-card-option-info">
            <div className="Home-token-card-option-title">
              <Trans>
                Market-specific liquidity tokens for IntelMarkets V2. Each market has its own token that earns fees from trading activity.
              </Trans>
            </div>
          </div>
          ...
          <div className="Home-token-card-option-apr">
            <Trans>Current Max. APY:</Trans> {maxMarketApyText?.[ETHEREUM]}
          </div>
        </div>
