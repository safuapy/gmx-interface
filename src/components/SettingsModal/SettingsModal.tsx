              ...
              <InputSetting
                ...
                description={
                  <div>
                    ...
                    <br />
                    <br />
                    <ExternalLink href="https://docs.intelmarkets.trade/docs/trading/v2/#network-fee-buffer">
                      Read more
                    </ExternalLink>
                  </div>
                }
              ...
              <TooltipWithPortal
                content={
                  <div onClick={(e) => e.stopPropagation()}>
                    ...
                    <br />
                    <br />
                    <ExternalLink href="https://docs.intelmarkets.trade/docs/trading/v2/#auto-cancel-tp--sl">
                      Read more
                    </ExternalLink>
                  </div>
                }
