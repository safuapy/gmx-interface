        ...
        protocol called the IntelMarket Protocol (the "IntelMarket Protocol," "Protocol," or "IntelMarket DApp"). IntelMarkets.trade is not an
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                ...
                <li>
                  <p className="body-text">
                    6.3. You understand that the Ethereum blockchain remains under development, which
                    ...
                    the Ethereum blockchain is variable and may increase at any time, causing an impact on
                    any activities taking place on this blockchain, which may result in price fluctuations or
