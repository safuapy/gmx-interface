...
//     at Oz.fetchOracleCandles (https://app.gmx.io/assets/index-BvC090tH.js:11:120914)
//     at ist.getLimitBars (https://app.g`
...
const parser = new SourceMapsParser();
parser.applySourceMap(errorString)